...
- **The CSP is generated by `tools/build-csp.mjs`, and `--check` is a ship
  ...
  produce a nonce; the third option, and the one this repo took, is **hashes**. There are **49
  ...
  a day is that *157* was counted instead of *49*. **A hash list is a second description of the
