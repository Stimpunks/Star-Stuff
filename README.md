...
| `eternal-sunshine-zine.html` | **Eternal Sunshine** *(Zine No. 6)* | A golden-hour adaptation of the Eternal Sunshine page. Six spreads on the Sun as our nearest star, fusion and warmth, and the counter-deficit turn — the light was always yours, the sky was in the way — plus affirmations, a "Not:" refusals set, and the tagline "Authenticity is our eternal sunshine, and brighter days are built together." |
...
| `the-universe-runs-on-difference-zine.html` | **The Universe Runs on Difference** *(Zine No. 8)* | Variety as resilience, monoculture as the fragile engineered thing. Runs the "Cavendish argument" across four scales — the near-uniform early universe (CMB smooth to ~1 part in 100,000; differences seeded all structure), the Cavendish banana monoculture, neurodiversity via the spiky profile (Damian Milton) and the competency network (Lori Hogenkamp; "not insurance — that's ecology"), and ethodiversity (Ombre Tarragnat) — the more-than-human variety of ways of being. Atkinson Hyperlegible family, full-spectrum palette, five diagrams, and a "Not:" refusals set guarding the superpower/extraction traps. |
