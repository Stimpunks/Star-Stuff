---
title: "The Bow-ery"
url: "https://starstuff.earth/bow-ery.html"
updated: "2026-08-29"
description: "Ten bows drawn to a single angular scale — three units to the degree, every plate centred the same way, so the radii can be compared by eye instead of taken on trust. A specimen sheet, and the third of the -ery sheets after The Hatchery and The Quillery. Each drawing carries one checkable thing: Newton saw five colours in 1670 and printed seven in Opticks in 1704, adding orange and indigo where the half-steps fall in the diatonic scale; the secondary bow is 43% as bright as the primary and Alexander of Aphrodisias recorded the dark band between them around 200 CE; supernumerary arcs cannot be produced by geometric optics at all and Thomas Young explained them by interference in 1804; a 22-degree ice halo is centred on the sun rather than opposite it, at about half the primary's radius; the circumhorizontal arc needs the sun above 58 degrees and is impossible north of 55N; the glory's precise mechanism is still called obscure; the third-order bow stands around the sun and was first photographed in 2011; a moonbow carries every colour to rods that cannot report them. And the pink these are drawn in is in none of them."
...
omitted_diagrams: 18  # inline <svg>, decoration on this page — the HTML is the artifact
---
...
The third of the **“-ery”** sheets, after [The Hatchery](https://starstuff.earth/hatchery.html)’s twelve cosmic eggs and [The Quillery](https://starstuff.earth/quillery.html)’s eight Esmx. Same rule as both: **every drawing carries one checkable thing**, with its source under it. The companion catalogue is [A Field Guide to Rainbows](https://starstuff.earth/rainbows-field-guide.html) (No. 20), which sorts bows by what physically changed. This sheet asks the smaller question that a catalogue cannot answer in prose — *how big is it, and where in the sky do I turn to look?*
...
The bow nearly everyone has seen, and the only plate here with no counterpart in [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html). That guide sorts bows by *what changed*, and in this one nothing has. **It is the reference, not an entry** — which is why its dashed ghost appears on all nine of the others.
...
**Sources:** Angles, relative brightness and the no-light-returned explanation of the dark band all follow Stull, R., *Practical Meteorology*, and are the same figures printed in [Both Arcs, One Drop](https://starstuff.earth/both-arcs-one-drop-zine.html) (No. 70) and [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html) — deliberately, because a sheet and its zine disagreeing about a number is worse than either being wrong alone. Alexander of Aphrodisias, c. 200 CE, for the band’s first record and its name. **The argument this plate does not make** — that “secondary” is a rank the physics does not contain — is No. 70’s.

As [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html#the-double) draws it: same two arcs, no scale, at 104×96.
...
As [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html#supernumerary) draws it, with the ray model crossed out.
...
As [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html#fogbow) draws it: colours beneath, white on top.
...
**Sources:** Hexagonal plate and column crystals, the 22° minimum-deviation angle, and sun dogs as the horizontal-plate case: standard halo optics via *Atmospheric Optics*. *Drawn with the sun on the horizon so the geometry is legible;* at any real solar elevation the ring rides with the sun and the dogs stay level with it. Field Guide No. 20 files all of this under a single withheld card, [The Ones That Are Not Rainbows](https://starstuff.earth/rainbows-field-guide.html#ice-halos), with no reframe table.

As [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html#ice-halos) draws it: the crystal, and a bow crossed out.
...
No counterpart glyph. [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html#ice-halos) files this inside its single ice-halo card rather than giving it one of its own.
...
As [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html#glory) draws it, question mark and all.
...
As [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html#higher-order) draws it: rings around the sun, no scale.
...
As [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html#moonbow) draws it: grey bow, colour bow, moon and camera.
...
**Sources:** Geometry, and it needs no citation beyond the antisolar point being below the horizon whenever the sun is above it. *Drawn with the centre exactly on the horizon,* which corresponds to the sun exactly on the opposite horizon — the case that gives the largest arc anyone on the ground can see. Field Guide No. 20 makes the same point in prose at [The Arc Was Never An Arc](https://starstuff.earth/rainbows-field-guide.html#full-circle).

As [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html#full-circle) draws it: solid above, dashed below.

## What we left out, and the colour that is not here

Notes

**The colour these are drawn in is in none of them.** This site’s palette runs on a pink, `#f472b6`, and it appears on nine of the ten plates above. **Magenta is not in the spectrum.** There is no wavelength that produces it: it is what the visual system builds when the long-wavelength and short-wavelength cones fire together and the middle one does not, and the brain closes a ring that the physics leaves open. So a sheet of ten bows, drawn as carefully to scale as we could manage, is drawn partly in a colour that no rainbow contains — and there is no version of these drawings that fixes it, because the pink is doing a job the spectrum has no way to do. *We are not going to pretend that is a flaw we overlooked. It is the most interesting thing on the page.*

**We left out the sea spray bow, the twinned bow and the Titan bow, and the reason is this sheet’s own rule.** All three are in [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html) and all three are good. None of them can be drawn to scale in a way that tells you anything: a sea spray bow differs from a rainbow by **0.8°**, which at three units to the degree is 2.4 units — about the width of the stroke it would be drawn in. A twinned bow’s split comes from drops flattened by one or two per cent. A Titan bow is at 49°, which would look like a slightly larger rainbow and teach nobody anything, because the interesting part is the liquid and not the angle. *A specimen sheet organised around scale has to decline the entries where scale is not the story*, and saying so is better than quietly dropping them.

**The reflection bow was cut for a worse reason, and it is worth admitting.** It belongs here by every test — it is a scale-and-position phenomenon, it is beautiful, and it is the single commonest cause of a photograph captioned “triple rainbow.” It came out because drawing it honestly needs a *second centre* on the plate (the reflected sun has its own antisolar point above the horizon), and two centres on a sheet whose entire premise is one shared centre would have undermined the thing the sheet is for. That is a limitation of the format we chose, not a fact about the bow. It is carded properly at [Field Guide No. 20](https://starstuff.earth/rainbows-field-guide.html#reflection-bow).

**Two plates break the shared centre, and both say so on their own faces rather than here.** [The Circumhorizontal Arc](#the-circumhorizontal-arc) moves the sun to the top of the frame, because the arc sits 46° *below* the sun and would otherwise be off the bottom of the plate; the scale is unchanged. [The 22° Halo](#the-22-degree-halo) and [The Third and Fourth Order](#the-third-order) are centred on the sun rather than the antisolar point, which is not a break in the convention but the whole content of those two plates — *they are on the other side of the sky, and the drawing is how you find that out.*

**What the scale is worth, stated plainly.** The radii here are computed from published angles at three units to the degree, and they are as good as those angles. Everything else is drawn for legibility: band widths are exaggerated (the primary’s by about 2.8×, and the plate prints that), brightness is suggestive rather than measured, and the sky is left out entirely. **Where a figure is load-bearing it is printed on the plate and sourced under it.** The two figures we would most like to improve are the circumhorizontal arc’s London and Los Angeles hours, which reached no primary computation and carry more of the argument than any other numbers on the page.

**On paper, this sheet loses its colour, and that is the right trade.** The shared print stylesheet turns every SVG stroke to a single dark grey, because our five accents measure between **1.7:1 and 2.9:1 against white** and not one of them clears the 3:1 a graphic needs to be legible. So a printed Bow-ery is line art. *The geometry — which is the whole point — survives intact:* a 22° halo still prints at half a rainbow’s radius, and Alexander’s dark band still prints 7.3° wide. What is lost is band order, which is why every plate whose argument is a colour order also prints that order as a label. A page about colour that cannot print its colour is worth writing down rather than hiding.
