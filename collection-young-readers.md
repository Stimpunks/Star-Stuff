...
A Star Stuff collection · 14 pieces · started 6 September 2026
...
### [Seeds That Wait](https://starstuff.earth/seeds-that-wait-zine.html)

Zine No. 93 · Stimpunks Zines · read-aloud, ages 4–8
...
### [The Colours You Cannot See](https://starstuff.earth/the-colours-you-cannot-see-zine.html)

Zine No. 94 · Stimpunks Zines · read-aloud, ages 4–8
...
### [Bone Song, Read Aloud](https://starstuff.earth/bone-song-read-aloud-zine.html)

Zine No. 95 · Stimpunks Zines · read-aloud of No. 1 · ages 4–8
...
### [The Dog Breathes Out Sideways](https://starstuff.earth/the-dog-breathes-out-sideways-zine.html)

Zine No. 99 · Stimpunks Zines · read-aloud, ages 4–8
...
### [Almost All of It Is Holes](https://starstuff.earth/almost-all-of-it-is-holes-zine.html)

Zine No. 100 · Stimpunks Zines · read-aloud, ages 4–8
...
### [One Ear Higher Than the Other](https://starstuff.earth/one-ear-higher-than-the-other-zine.html)

Zine No. 101 · Stimpunks Zines · read-aloud, ages 4–8
...
### [It Stays Green, and Then It Goes](https://starstuff.earth/it-stays-green-and-then-it-goes-zine.html)

Zine No. 102 · Stimpunks Zines · read-aloud, ages 4–8
...
### [More Than One Way to Spell It](https://starstuff.earth/more-than-one-way-to-spell-it-zine.html)

Zine No. 106 · Stimpunks Zines · read-aloud, ages 4–8
...
Four letters read in threes make sixty-four words. There are twenty beads to name. So glycine has four spellings and leucine has six, and all of them are right.

**Details**

**The companion No. 105 promised on its own face.** That zine said in its grown-up layer that the genetic code “is not in this zine at all”; this is the promise kept. The letters are read three at a time, each three-letter word — a codon — naming one amino acid, one bead on a protein string. Then the arithmetic does the arguing. Four letters read in threes give sixty-four possible words, and there are only twenty beads to name plus a stop signal, so sixty-one naming codons distribute as five fourfold sets, nine twofold, three sixfold, one threefold and two singletons — which sums to exactly twenty, every amino acid once. Nearly everything therefore has more than one correct spelling: glycine four, leucine and serine and arginine six each, and only methionine and tryptophan one. **The demonstration is the mechanism, on paper.** GGU is glycine; change the last letter to any of the four and it is still glycine; change the first and it is serine. Every codon on the page was checked against the NCBI standard translation table rather than written from memory, because the game fails if one row is wrong. **And the exception is inside the reader this time.** NCBI lists thirty-three translation tables, and a human body runs two at once — mitochondria read UGA as tryptophan where the rest of you reads it as stop, which is the sharpest evidence for what No. 7 argued about a bacterium that never quite stopped being itself. **What the zine refuses is the reason spread ten is in plain type rather than in a box.** Its companion stayed safe by never saying what DNA does; this one cannot, so it corrects the popular meaning of “genetic code” directly: the table names which bead comes next and contains no entry for a trait, an ability or a person. It also declines to call the code kindly arranged — the famous error-minimising result sits against Crick’s frozen accident, and how the code got its shape is an open argument. Twelve spreads, four figures, five refusals for the adult.

### [The Onion Has More Than You](https://starstuff.earth/the-onion-has-more-than-you-zine.html)

Zine No. 107 · Stimpunks Zines · read-aloud, ages 4–8
...
If it were the plan for you, a more complicated thing would need a bigger plan. An onion has five times more, and a worm a millimetre long has about as many genes. Nobody drew you.

**Details**

**The third part of an arc, and the one that answers the question the other two leave open.** No. 105 gave the four-letter alphabet and No. 106 gave the code that reads it three letters at a time; both stopped short of asking what the whole thing *is*. This one asks, and checks rather than asserts. A plan is a drawing of a finished thing made in advance, so a more complicated thing needs a bigger drawing — that is a prediction, and it fails twice. By quantity: an onion carries about 16,400 million bases against a human 3,200 million, roughly five times more. **And the objection is handed to the child before it is answered.** Counting letters is unfair, because at least 95 per cent of the onion genome is repetitive sequence — so the zine counts instructions instead, and that is worse for the metaphor rather than better. Before anybody had counted, human gene estimates ran to 100,000; the answer came in near 20,000, about the same as *Caenorhabditis elegans*, a worm a millimetre long with 959 body cells, whose entire genome is thirty-two times smaller. Then the strongest form: within the onion genus alone, genome size varies four and a half fold, so onions disagree with other onions by more than onions disagree with us. **What replaces the metaphor is older than the metaphor.** Schrödinger coined *code-script* in 1944 and wrote in the same paragraph that the term is “of course, too narrow,” because chromosomes are “architect’s plan and builder’s craft — in one.” The plan and the building are the same thing, and there is no finished you in there to be a drawing of. The history of how that qualifier got dropped is a chain and is deliberately not in here. Twelve spreads, four figures, five refusals for the adult; the zine stops at onions and worms and never argues about people.

### [A Bit of Scruff](https://starstuff.earth/a-bit-of-scruff-zine.html)

Zine No. 109 · Stimpunks Zines · read-aloud, ages 4–8
...
The telescope had no screen. It had pens, and ninety-six feet of paper a day, and somebody who read all of it by hand. What she found was a new kind of star. Whose name went on it is the other half.

**Details**

**The first piece here about who gets named, and it is built almost entirely out of the discoverer’s own account.** Jocelyn Bell spent two years helping build a radio telescope across four and a half acres — “an area that would accomodate 57 tennis courts” — and then read what it drew: “between them they produced 96 feet of chart paper every day. The charts were analyzed by hand—by me.” The group had chosen not to computerise the analysis, because “a human can recognize signals of different character whereas it is difficult to program a computer to do so” — and the discovery is downstream of that sentence. **Then three months of failure**, which the zine keeps, because a child told only about the moment of discovery learns that finding nothing means you were wrong to look.

**And it refuses the easy telling, because she refused it herself.** Her name is second of five on the 1968 *Nature* paper — the widely circulated version in which she was left off the paper is false, and the zine says so. The 1974 Nobel went to her supervisor without her, and in 1977 she gave four reasons she should not have shared it, ending “I am not myself upset about it.” So the zine hands the child the harder and truer distinction: **being kind about something is not the same as the something being fair**, and a reader may reach their own verdict. What she *does* record as absurd is the press, who on finding a woman was involved “descended even faster”, photographed her examining bogus records, and asked how many boyfriends she had. Then 2018, and the &pound;2.3 million she gave away entire — to students including disabled students — saying “I don’t need the money myself.” It ends on the one thing a four-year-old can do about any of it, which takes four words.
...
The reason it needed its own shelf rather than a tag: these three would otherwise sit in [Star Stuff](https://starstuff.earth/collection-star-stuff.html), which is entirely correct by register — each of them takes one settled, checkable fact and follows it until the belonging claim is already inside it. **They pass that test and they still cannot be found by anybody looking for them.** A caregiver hunting for something to read to a five-year-old was never going to locate three read-alouds scattered through a grid of adult zines, which is the situation this page was opened to fix, and discoverability is the entire job of a collection page.

This is the same reasoning that put [Field Guides](https://starstuff.earth/collection-field-guides.html) and [How We Got Here](https://starstuff.earth/collection-how-we-got-here.html) on their own shelves while their members remained, by register, Star Stuff pieces. *The number says when. The collection says what — or here, for whom.*
...
**Nine of the fourteen pieces hand the child something to *do***, and they do it in **three different ways**. This was not planned. It is a form that turned up in finished work, which is the only kind of convention this site names.

**The nine are named here rather than counted, because this number drifted three times before anybody caught it.** [No. 94](https://starstuff.earth/the-colours-you-cannot-see-zine.html), [No. 96](https://starstuff.earth/the-cuttlefish-that-cannot-see-colour-zine.html), [No. 99](https://starstuff.earth/the-dog-breathes-out-sideways-zine.html), [No. 100](https://starstuff.earth/almost-all-of-it-is-holes-zine.html), [No. 101](https://starstuff.earth/one-ear-higher-than-the-other-zine.html), [No. 102](https://starstuff.earth/it-stays-green-and-then-it-goes-zine.html), [No. 105](https://starstuff.earth/the-same-four-letters-zine.html) and [No. 106](https://starstuff.earth/more-than-one-way-to-spell-it-zine.html) and [No. 109](https://starstuff.earth/a-bit-of-scruff-zine.html). The cause of the drift is worth stating, because it is not carelessness: “something to do” is a wider set than “a demonstration”, and for a long time one number was doing both jobs. No. 102 and [No. 109](https://starstuff.earth/a-bit-of-scruff-zine.html) have no demonstration and are listed below as having none — and both still hand the child a method to carry out, so they are in this nine. The two sets differ by exactly that piece, and a count that does not say which set it means will keep coming apart. *No gate can see any of this*, which is the whole reason the members are written out.
...
**And the fifth is the first one a child can get a surprising result from.** [No. 106](https://starstuff.earth/more-than-one-way-to-spell-it-zine.html) puts six rows of the genetic code on the spread and has the child look up GGU, change its last letter to anything at all, and look it up again — glycine every time — then change the *first* letter and watch it become something else. Where No. 105 had the child perform a piece of reasoning, this one hands them a lookup table and lets them find a pattern in it that nobody told them about. **It also carries the risk that comes with that:** a child who tests a different word may find the last letter mattering after all, because not every set of four behaves like glycine’s. The grown-up box says so outright, and says that a child who finds it has found a real thing rather than made a mistake — which is the fourth rule again, in the one place where a demonstration can genuinely come out otherwise.
...
**And this is not a quota.** [No. 91](https://starstuff.earth/nobody-in-this-pond-is-late-zine.html), [No. 93](https://starstuff.earth/seeds-that-wait-zine.html), [No. 102](https://starstuff.earth/it-stays-green-and-then-it-goes-zine.html), [No. 104](https://starstuff.earth/just-right-for-whom-zine.html) and [No. 107](https://starstuff.earth/the-onion-has-more-than-you-zine.html) and [No. 109](https://starstuff.earth/a-bit-of-scruff-zine.html) have no *demonstration* — which is not the same list as the **five** that hand the child nothing at all ([No. 91](https://starstuff.earth/nobody-in-this-pond-is-late-zine.html), [No. 93](https://starstuff.earth/seeds-that-wait-zine.html), [No. 95](https://starstuff.earth/bone-song-read-aloud-zine.html), [No. 104](https://starstuff.earth/just-right-for-whom-zine.html) and [No. 107](https://starstuff.earth/the-onion-has-more-than-you-zine.html)), because No. 102 and No. 109 offer a method instead and No. 95 offers an image; the paragraph above says why those two sets differ, and are not worse for it — you cannot do spadefoot metamorphosis, or a seed’s decade of waiting, or a whole autumn, or stellar evolution, or the weighing of a genome, on a table in five minutes, and a forced demonstration is worse than none. What No. 102 offers instead is the *method*: pick one leaf, mark it, and look at it every day. That is a season rather than an afternoon, and it is the actual experiment. *Reach for one when the mechanism is small enough to fit in a room.* **And [No. 107](https://starstuff.earth/the-onion-has-more-than-you-zine.html) offers a third thing again, which is neither.** It hands the child a *check*: a claim everybody makes, the prediction that follows from it, and two goes at testing it against real numbers. Nothing is done at the table and nothing is observed — the child is taken through an argument and shown where it fails. That is a fourth shape, and it is listed above as having no demonstration because it has none. No gate can see any of this either. It is the second house rule on this page held by a person rather than by a tool.
...
Where an argument about people is actually wanted, it is linked rather than borrowed: Stimpunks makes it on human evidence at [Developmental Pace](https://stimpunks.org/why/developmental-pace/), whose own sentence is sharper than anything on these pages — *“Behind” is information about the ruler, not about the learner.*

## How this collection opened, and at what count

At **three members** (fourteen now), on a form observed in finished work — which clears the two-member floor rather than arguing around it. That matters because the floor has been broken three times on this site, each time with a written reason, and this collection did not need to.
...
[Stimpunks Foundation](https://stimpunks.org/) × [More Realms](https://morerealms.com/) · Young Readers · L★S
