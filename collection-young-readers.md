...
A Star Stuff collection · 13 pieces · started 6 September 2026
...
**Eight of the thirteen pieces hand the child something to *do***, and they do it in **three different ways**. This was not planned. It is a form that turned up in finished work, which is the only kind of convention this site names.

**The eight are named here rather than counted, because this number drifted three times before anybody caught it.** [No. 94](https://starstuff.earth/the-colours-you-cannot-see-zine.html), [No. 96](https://starstuff.earth/the-cuttlefish-that-cannot-see-colour-zine.html), [No. 99](https://starstuff.earth/the-dog-breathes-out-sideways-zine.html), [No. 100](https://starstuff.earth/almost-all-of-it-is-holes-zine.html), [No. 101](https://starstuff.earth/one-ear-higher-than-the-other-zine.html), [No. 102](https://starstuff.earth/it-stays-green-and-then-it-goes-zine.html), [No. 105](https://starstuff.earth/the-same-four-letters-zine.html) and [No. 106](https://starstuff.earth/more-than-one-way-to-spell-it-zine.html). The cause of the drift is worth stating, because it is not carelessness: “something to do” is a wider set than “a demonstration”, and for a long time one number was doing both jobs. No. 102 has no demonstration and is listed below as having none — and it still hands the child a method to carry out, so it is in this eight. The two sets differ by exactly that piece, and a count that does not say which set it means will keep coming apart. *No gate can see any of this*, which is the whole reason the members are written out.
...
At **three members** (thirteen now), on a form observed in finished work — which clears the two-member floor rather than arguing around it. That matters because the floor has been broken three times on this site, each time with a written reason, and this collection did not need to.
